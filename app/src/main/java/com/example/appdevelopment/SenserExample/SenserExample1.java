package com.example.appdevelopment.SenserExample;
...
public class SenserExample1 extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_senser_example1);
        textView=findViewById(R.id.txtSenser1);
    ...
    public void getSensorValues(SensorEvent event){
        ...
        if(acceleration>2){
            ...
            textView.setText("Mobile was move!!");
            if(color){
